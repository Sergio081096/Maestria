...
CLIPS es un entorno para el desarrollo de sistemas basados en conocimiento que ofrece hechos, plantillas, reglas de producción, funciones y un motor de inferencia que permite razonar sobre una base de eventos utilizando reglas del tipo if-then \cite{Giarratano2005}. 
